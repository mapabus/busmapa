class BusMapApp {
  constructor(config) {
    ...
    this.routeLayers = {}; // Store route polylines
    this.colors = config.colors;
    this.directionColorMap = {};
    this.allMarkers = {};
    this.stationsMap = {};
    this.routeNamesMap = {};
    this.shapesData = {}; // Store shapes data
    this.vehicleShapeMap = {}; // Map vehicle to its shape_id
    this.refreshInterval = config.refreshInterval;
    this.activeRouteLayer = null; // Currently displayed route
  ...
  drawMarkers(vehicles, vehicleDestinations) {
    ...
    vehicles.forEach(vehicle => {
      ...
      marker.on('click', () => {
        this.showRouteForVehicle(vehicle.id, markerColor);
      });
  ...
  showRouteForVehicle(vehicleId, color) {
    ...
    const shapeId = this.vehicleShapeMap[vehicleId];
    
    if (!shapeId) {
      console.log('No shape_id found for vehicle:', vehicleId);
      return;
    }
    ...
    // Create polyline from shape points
    ...
    console.log('Route displayed for vehicle:', vehicleId, 'with', shapePoints.length, 'points');
  }
  ...
  searchVehicles(query) {
    ...
    resultsToShow.forEach(vehicle => {
      ...
      resultItem.onclick = () => {
        ...
        this.showRouteForVehicle(vehicle.vehicleId, vehicle.markerColor);
